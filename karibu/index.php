...
$index = 0;
$files = array();
$iterator = new DirectoryIterator(dirname(__FILE__, 2));
...
foreach ($iterator as $fileinfo) {
    ...
    $isExclude = in_array( $filename, array('assets', 'dashboard', 'docs', 'localhost', 'webalizer'));
        ...
        <section class="w-100">
            ...
            <?php foreach( $files as $file ) { ?>
                <article class="fl w-100 w-50-m w-25-l pa4">
                    <a href="/<?php echo $file["path"]; ?>" target="blank">
